#!/usr/bin/env python3
"""
Ingestion script with fallback embeddings to ensure book content is loaded
This script will load, chunk, and store the actual book content from MDX files.
"""
import sys
import os
...
def ingest_book_content():
    ...
    print("Starting ingestion of actual book content with fallback embeddings...")
    print("=" * 60)
    ...
    # Import the services to store content
...
if __name__ == "__main__":
    print("Robust Book Content Ingestion System with Fallback Embeddings")
    print("This script will ingest the actual book content from MDX files into the RAG system.")
    print("Each module will be chunked (1000 tokens) and stored in Qdrant.")
    print("Fallback embeddings are used to ensure content is loaded even with API issues.\n")
