...
#     session = SessionService.create_session(user_id=None)
#     return CreateSessionResponse(session_id=session.id)
...
#         try:
#             print("\n==============================")
#             print("CHAT ROUTER RECEIVED:", chat_request.message)
#             print("==============================\n")

#             # ✅ SIMPLE RAG CALL
#             rag = RAGService()
#             rag_response = rag.generate_response(chat_request.message)
...
# =========================
# LOCAL HARDCODED ANSWERS
# =========================

def get_local_answer(message: str):
    message = message.lower()

    qa = {

        # greeting
        "hello": "Hello 🙂 How can I help you with Physical AI & Humanoid Robotics?",
        "hi": "Hi 🙂 Ask me anything about Modules 1 to 6.",

        # MODULE 1
        "module 1": "Module 1 explains the basics of Physical AI and Humanoid Robotics, including history, importance, and real world applications.",
        
        # MODULE 2
        "module 2": "Module 2 focuses on robot hardware, sensors, actuators, and how robots interact with the physical environment.",
        
        # MODULE 3
        "module 3": "Module 3 explains robot perception including computer vision, environment sensing, and data interpretation.",
        
        # MODULE 4
        "module 4": "Module 4 covers robot motion planning, navigation systems, and control algorithms.",
        
        # MODULE 5
        "module 5": "Module 5 explains robot learning, machine learning integration, and adaptive intelligent behaviour.",
        
        # MODULE 6
        "module 6": "Module 6 focuses on advanced humanoid intelligence, real-time decision making, and autonomous behaviour systems.",

        # common questions
        "what is humanoid robotics": "Humanoid robotics is the field of robotics that designs robots which look and behave like humans.",
        "what is physical ai": "Physical AI combines artificial intelligence with real world physical systems like robots.",
        "what is ros 2": "ROS 2 is robotics middleware that allows different robot components to communicate.",
    }
...
async def chat(chat_request: ChatRequest):
    ...
    # check local answers
    local_answer = get_local_answer(chat_request.message)
    ...
    # default fallback
    return ChatResponse(
        response="Sorry 😔 mujhe is question ka answer nahi mila. Please Modules 1 to 6 se related sawal poochain.",
        session_id=chat_request.session_id
    )